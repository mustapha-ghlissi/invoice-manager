...
if(isset($_POST['ref']))
{
  $quote = $quoteCRUD->getQuoteByRef($_POST['ref']);
  if($quote !== null)
  {
  ...
  $idQuote = $quoteCRUD->saveQuote($quote);
  ...
  <div class="page-content container-fluid">
    <div class="row" data-plugin="matchHeight" data-by-row="true">
      <div class="col-lg-12">
        <div class="panel">
          ...
          <div class="panel-body">
            <form name="quoteForm" action="<?php echo($_SERVER['PHP_SELF']) ?>" id="newFormQuote" method="post">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="ref">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" name="creationDate" data-plugin="datepicker" id="creationDate" class="form-control form-control-sm" placeholder="Pick start date">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" name="dueDate" data-plugin="datepicker" id="dueDate" class="form-control form-control-sm" placeholder="Pick due date">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
    ...
    <div class="col-md-12">
      <div class="form-group text-right">
        <button class="btn btn-primary" id="saveQuote" name="saveQuote">
          Save quote <i class="white-500 wb wb-file"></i>
        </button>
      </div>
    </div>
  </div>
...
$(document).ready(function(){
  ...
  $('#newFormQuote').on('submit',function(e){
    e.preventDefault();
    if($('#amount').val() === "")
    {
    ...
    saveQuote($(this), "<?php echo($_SERVER['PHP_SELF']) ?>");
  });
